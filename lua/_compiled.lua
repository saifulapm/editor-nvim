...
_G.packer_plugins = {
  ...
  ["fzy-lua-native"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/saiful/.local/share/nvim/site/pack/packer/opt/fzy-lua-native"
  },
  ["gitlinker.nvim"] = {
  ...
  ["nvim-autopairs"] = {
    config = { "\27LJ\2\næ\1\0\0\3\0\6\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\0\0'\2\4\0B\0\2\0029\0\2\0005\2\5\0B\0\2\1K\0\1\0\1\0\3\vmap_cr\2\16auto_select\2\17map_complete\2\"nvim-autopairs.completion.cmp\1\0\2\rcheck_ts\1\24close_triple_quotes\2\nsetup\19nvim-autopairs\frequire\0" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "tabout.nvim", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "treesitter-unit", "nvim-treesitter-textobjects" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'vim-apathy', 'nvim-colorizer.lua', 'emmet-vim'}, { ft = "typescript" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'marks.nvim', 'vim-fold-cycle', 'vim-highlighturl', 'nvim-hclipboard', 'vim-niceblock', 'Comment.nvim', 'vim-operator-surround', 'vim-projectionist', 'vim-surround', 'vim-textobj-comment', 'vim-repeat', 'nvim-neoclip.lua', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
