...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp_luasnip", "tabout.nvim", "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "spellsitter.nvim", "nvim-ts-rainbow", "treesitter-unit" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'spaceless.nvim', 'nvim-cmp', 'better-escape.nvim', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-highlighturl', 'vim-fold-cycle', 'marks.nvim', 'vim-repeat', 'indent-blankline.nvim', 'vim-textobj-comment', 'vim-surround', 'nvim-neoclip.lua', 'nvim-hclipboard', 'vim-projectionist', 'vim-operator-surround', 'Comment.nvim', 'vim-niceblock'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter *.wiki ++once lua require("packer.load")({'vimwiki'}, { event = "BufEnter *.wiki" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-sleuth', 'conflict-marker.vim', 'vim-asterisk', 'nvim-treesitter'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
