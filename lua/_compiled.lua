...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp_luasnip", "tabout.nvim", "cmp-path", "nvim-autopairs", "cmp-buffer", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "spellsitter.nvim", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "treesitter-unit" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-asterisk', 'nvim-treesitter', 'conflict-marker.vim', 'vim-sleuth'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-projectionist', 'vim-operator-surround', 'Comment.nvim', 'vim-niceblock', 'vim-highlighturl', 'vim-fold-cycle', 'marks.nvim', 'indent-blankline.nvim', 'nvim-neoclip.lua', 'vim-surround', 'nvim-hclipboard', 'vim-textobj-comment', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
