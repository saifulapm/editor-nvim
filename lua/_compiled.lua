...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "tabout.nvim", "cmp-buffer", "nvim-autopairs", "cmp-cmdline", "cmp-path", "cmp-spell" },
  ...
  ["nvim-treesitter"] = {
    after = { "spellsitter.nvim", "treesitter-unit", "nvim-ts-rainbow", "nvim-treesitter-textobjects" },
  ...
  ["spaceless.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/saiful/.local/share/nvim/site/pack/packer/opt/spaceless.nvim"
  },
  ["spellsitter.nvim"] = {
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-apathy'}, { ft = "typescript" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'Comment.nvim', 'vim-fold-cycle', 'nvim-hclipboard', 'marks.nvim', 'vim-textobj-comment', 'vim-projectionist', 'vim-highlighturl', 'indent-blankline.nvim', 'vim-niceblock', 'vim-repeat', 'vim-operator-surround', 'nvim-neoclip.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter *.wiki ++once lua require("packer.load")({'vimwiki'}, { event = "BufEnter *.wiki" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'conflict-marker.vim', 'nvim-treesitter', 'vim-asterisk', 'vim-sleuth'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'better-escape.nvim', 'nvim-cmp', 'spaceless.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
