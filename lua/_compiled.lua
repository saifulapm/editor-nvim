...
_G.packer_plugins = {
  ...
  ["nvim-autopairs"] = {
    config = { "\27LJ\2\næ\1\0\0\3\0\6\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\0016\0\0\0'\2\4\0B\0\2\0029\0\2\0005\2\5\0B\0\2\1K\0\1\0\1\0\3\17map_complete\2\vmap_cr\2\16auto_select\2\"nvim-autopairs.completion.cmp\1\0\2\24close_triple_quotes\2\rcheck_ts\1\nsetup\19nvim-autopairs\frequire\0" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
  ...
  ["nvim-cmp"] = {
    after = { "tabout.nvim", "nvim-autopairs", "cmp-path", "cmp_luasnip", "cmp-nvim-lua", "cmp-spell", "cmp-buffer" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "spellsitter.nvim", "treesitter-unit", "nvim-treesitter-textobjects" },
  ...
  ["vim-visual-multi"] = {
    config = { "\27LJ\2\n—\1\0\0\2\0\b\0\r6\0\0\0009\0\1\0'\1\3\0=\1\2\0006\0\0\0009\0\1\0'\1\5\0=\1\4\0006\0\0\0009\0\1\0005\1\a\0=\1\6\0K\0\1\0\1\0\4\15Find Under\n<C-e>\21Select Cursor Up\a\\k\23Select Cursor Down\a\\j\23Find Subword Under\n<C-e>\fVM_maps\rcodedark\rVM_theme\14underline\25VM_highlight_matches\6g\bvim\0" },
    keys = { { "", "<C-e>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType css ++once lua require("packer.load")({'nvim-colorizer.lua', 'emmet-vim'}, { ft = "css" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-colorizer.lua', 'emmet-vim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-colorizer.lua', 'emmet-vim', 'vim-apathy'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'nvim-colorizer.lua', 'emmet-vim'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufEnter *.wiki ++once lua require("packer.load")({'vimwiki'}, { event = "BufEnter *.wiki" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-fold-cycle', 'Comment.nvim', 'vim-highlighturl', 'vim-niceblock', 'vim-projectionist', 'nvim-hclipboard', 'vim-surround', 'nvim-neoclip.lua', 'vim-textobj-comment', 'indent-blankline.nvim', 'vim-repeat', 'marks.nvim', 'vim-operator-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
