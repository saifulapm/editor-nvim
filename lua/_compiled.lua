...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp_luasnip", "cmp-spell", "cmp-nvim-lua", "tabout.nvim", "cmp-buffer", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "treesitter-unit", "nvim-treesitter-textobjects", "spellsitter.nvim", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-smart-history.nvim", "telescope-frecency.nvim", "telescope-fzf-native.nvim", "telescope-tmux.nvim" },
    commands = { "Telescope" },
  ...
  ["vim-visual-multi"] = {
    config = { "\27LJ\2\n—\1\0\0\2\0\b\0\r6\0\0\0009\0\1\0'\1\3\0=\1\2\0006\0\0\0009\0\1\0'\1\5\0=\1\4\0006\0\0\0009\0\1\0005\1\a\0=\1\6\0K\0\1\0\1\0\4\21Select Cursor Up\a\\k\15Find Under\n<C-e>\23Find Subword Under\n<C-e>\23Select Cursor Down\a\\j\fVM_maps\rcodedark\rVM_theme\14underline\25VM_highlight_matches\6g\bvim\0" },
    keys = { { "", "<C-e>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-sleuth', 'nvim-treesitter', 'conflict-marker.vim', 'vim-asterisk'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'indent-blankline.nvim', 'vim-repeat', 'vim-operator-surround', 'vim-highlighturl', 'vim-niceblock', 'nvim-hclipboard', 'Comment.nvim', 'nvim-neoclip.lua', 'vim-projectionist', 'marks.nvim', 'vim-fold-cycle', 'vim-textobj-comment'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'emmet-vim', 'better-escape.nvim', 'LuaSnip', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
