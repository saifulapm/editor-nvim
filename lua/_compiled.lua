...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp-cmdline", "cmp-path", "cmp-buffer", "cmp_luasnip", "tabout.nvim", "cmp-spell" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "telescope-tmux.nvim", "telescope-smart-history.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'spaceless.nvim', 'nvim-cmp', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-hclipboard', 'marks.nvim', 'vim-repeat', 'indent-blankline.nvim', 'vim-operator-surround', 'vim-niceblock', 'vim-textobj-comment', 'vim-fold-cycle', 'vim-projectionist', 'vim-surround', 'vim-highlighturl', 'nvim-neoclip.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-sleuth', 'vim-asterisk', 'conflict-marker.vim', 'nvim-treesitter'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
