...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-path", "tabout.nvim", "nvim-autopairs", "cmp_luasnip" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-asterisk', 'conflict-marker.vim', 'vim-sleuth', 'nvim-treesitter'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-surround', 'marks.nvim', 'vim-fold-cycle', 'vim-highlighturl', 'vim-niceblock', 'nvim-hclipboard', 'nvim-neoclip.lua', 'Comment.nvim', 'vim-textobj-comment', 'vim-operator-surround', 'vim-projectionist', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
